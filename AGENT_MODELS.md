...
| 12 | **Editor** | Интерактивное редактирование | `anthropic/claude-sonnet-4-6` | Anthropic | Chat-to-Modify: JSON-патчи по запросу пользователя (search/replace) | 2 мин | 🟡 Пост-генерация — активируется после завершения основного пайплайна |
